        ...
        <div className="container mt-4">
          {store.contacts && store.contacts.length > 0 ? (
            store.contacts.map((contact) => (
              <div key={contact.id} className="row mb-3 p-3 border rounded bg-white shadow-sm align-items-center">
                <div className="col">
                  <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQk6onp_Iet4tM91LftudjOOQgK2raS-JkNjA&s" alt="Contact-img" className="img-fluid" />
                </div>
                <div className="col-8 text-start">
                  <div className='mb-2'><strong>Name:</strong> {contact.name}</div>
                  <div className='mb-2'><strong>Address:</strong> {contact.address}</div>
                  <div className='mb-2'><strong>Phone:</strong> {contact.phone}</div>
